...
public class ValidateCartContentsTest extends BaseTest {
    ...
    public void testUserRedirectToCartPageOnAddingProduct() {
        try {
            ...
            logger.error("Error occurred during test execution: testUserRedirectToCartPageOnAddingProduct", e);
    ...
    public void testProductListedInCartWithCorrectDetails() {
        try {
            ...
            logger.error("Error occurred during test execution: testProductListedInCartWithCorrectDetails", e);
            throw e; // Rethrow the exception to mark the test as failed
        }
    }
}
